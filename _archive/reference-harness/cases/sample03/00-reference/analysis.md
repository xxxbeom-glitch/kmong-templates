...
> 노티드 원디자인 반응형 · 데모몰 `ecudemo400494.cafe24.com` · 패션
...
- reconstructionDifficulty: **medium**
- skinRisk: **medium-high** (할인기간·쿠폰가·스마트배너·헤더겹침)

## 제거 후보

- 디자인센터 「운영하면서 손쉽게」 설명 오버레이(캡처 시 잔존 가능)
- 중복 listmain 블록 — normalized에서 2~3개로 축소 검토
