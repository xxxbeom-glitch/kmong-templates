# onetenth8 — Analysis (Creative 08)

**십분의일 - 크리에이티브 08** · https://onetenth8.mycafe24.com/
...
1. Hero 2버튼 (바로 시작하기 / 더 알아보기) + parallax 이미지
2. 소개 + YouTube 배경 video
3. 고객 후기 carousel (uicore-testimonial-carousel)
4. 템플릿 가치 proposition 3섹션
5. 요금제 6카드 (Basic/Standard/Premium × A/B)
6. FAQ accordion

**비고:** Element Pack motion FX·fade 애니메이션 다수
