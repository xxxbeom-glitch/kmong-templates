# Site Structure Audit — onetenth8 (Creative 08)

**원본:** https://onetenth8.mycafe24.com/ · **십분의일 - 크리에이티브 08**
...
| # | 역할 | 비고 |
|---|------|------|
| H | Hero | 프리미엄 홈페이지 템플릿, 십분의일… |
| 1 | Hero 2버튼 (바로 시작하기 / 더 알아보기) + parallax 이미지 | Creative 08 |
| 2 | 소개 + YouTube 배경 video | Creative 08 |
| 3 | 고객 후기 carousel (uicore-testimonial-carousel) | Creative 08 |
| 4 | 템플릿 가치 proposition 3섹션 | Creative 08 |
| 5 | 요금제 6카드 (Basic/Standard/Premium × A/B) | Creative 08 |
| 6 | FAQ accordion | Creative 08 |
| F | Footer + FAB | 공통 |
