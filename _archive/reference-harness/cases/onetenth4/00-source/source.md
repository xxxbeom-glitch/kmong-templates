...
|------|-----|
| caseId | `onetenth4` |
| displayName | 십분의일 테크 04 |
| designCenterUrl | https://onetenth4.mycafe24.com/ |
| demoMallUrl | https://onetenth4.mycafe24.com/ |
| productCode | ONETENTH04 |
...
node scripts/preview-original.js onetenth4
# 재기동: node scripts/preview-original.js onetenth4 --force
```
