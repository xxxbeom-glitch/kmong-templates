...
function tenfold_packages() {
  return array(
    'standard' => array(
      ...
      'name' => '템플릿형 제작',
      'headline' => "준비된 구조로,\n빠르고 효율적으로 시작합니다.",
      'description' => "완성도 있는 디자인 구조를 바탕으로\n브랜드 컬러와 콘텐츠에 맞게 조정해 구축하는 방식입니다.\n\n처음부터 모든 요소를 새롭게 설계하지 않아\n제작 기간과 비용을 줄이면서도\n안정적인 품질로 구축할 수 있습니다.",
      'summary' => array(
        array('label' => '제작 기간', 'value' => '최대 2주'),
        array('label' => '제작 비용', 'value' => '40만원부터'),
        array('label' => '제작 방식', 'value' => '템플릿형 제작'),
      ),
      'card_headline' => "준비된 구조로,\n빠르고 효율적으로 시작합니다.",
      'card_description' => "완성도 있는 디자인 구조를 바탕으로\n브랜드 컬러와 콘텐츠에 맞게 조정해 구축하는 방식입니다.",
      'card_recommended_label' => '이런 경우에 적합합니다',
      'card_recommended' => array(
        '빠른 일정으로 웹사이트를 오픈해야 하는 경우',
        '기본적인 브랜드와 서비스 소개가 필요한 경우',
        '예산과 제작 기간을 효율적으로 관리하고 싶은 경우',
      ),
      'card_included_label' => '기본 포함',
      'card_included' => '반응형 웹 · 기본 CMS · 문의 기능 · 검색 기본 설정',
      'card_summary' => array(
        array('label' => '제작 기간', 'value' => '최대 2주'),
        array('label' => '제작 비용', 'value' => '40만원부터'),
      ),
      'card_note' => '프로젝트 범위와 자료 준비 상황에 따라 달라질 수 있습니다.',
      'card_cta' => '템플릿형 자세히 보기',
      'recommended' => array(
        '빠른 일정으로 웹사이트를 오픈해야 하는 경우',
        '기본적인 브랜드와 서비스 소개가 필요한 경우',
        '예산과 제작 기간을 효율적으로 관리하고 싶은 경우',
    ...
    'custom' => array(
      ...
      'name' => '커스텀형 제작',
      'headline' => "사업의 목적부터,\n프로젝트에 맞게 새롭게 설계합니다.",
      'description' => "사업과 콘텐츠 구조를 먼저 정리하고\n브랜드에 맞는 화면과 사용자 흐름을 처음부터 설계하는 방식입니다.\n\n단순한 화면 제작을 넘어\n사이트가 무엇을 전달하고 어떻게 작동해야 하는지까지\n프로젝트에 맞게 설계합니다.",
      'summary' => array(
        array('label' => '제작 기간', 'value' => '최대 4주'),
        array('label' => '제작 비용', 'value' => '90만원부터'),
        array('label' => '제작 방식', 'value' => '커스텀형 제작'),
      ),
      'card_headline' => "사업의 목적부터,\n프로젝트에 맞게 새롭게 설계합니다.",
      'card_description' => "사업과 콘텐츠 구조를 먼저 정리하고\n브랜드에 맞는 화면과 사용자 흐름을 처음부터 설계하는 방식입니다.",
      'card_recommended_label' => '이런 경우에 적합합니다',
      'card_recommended' => array(
        '브랜드만의 차별화된 웹사이트가 필요한 경우',
        '기존 홈페이지를 전면 리뉴얼하는 경우',
        '메뉴와 콘텐츠 구조부터 정리가 필요한 경우',
      ),
      'card_included_label' => '기본 포함',
      'card_included' => '콘텐츠 구조 설계 · 맞춤 UI · 프로젝트별 CMS · 기능 연동',
      'card_summary' => array(
        array('label' => '제작 기간', 'value' => '최대 4주'),
        array('label' => '제작 비용', 'value' => '90만원부터'),
      ),
      'card_note' => '프로젝트 범위와 자료 준비 상황에 따라 달라질 수 있습니다.',
      'card_cta' => '커스텀형 자세히 보기',
      'recommended' => array(
        '브랜드만의 차별화된 웹사이트가 필요한 경우',
        '기존 홈페이지를 전면 리뉴얼하는 경우',
        '메뉴와 콘텐츠 구조부터 정리가 필요한 경우',
