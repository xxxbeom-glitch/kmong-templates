...
|------|-----|
| caseId | `onetenth3` |
| displayName | 십분의일 테크 03 |
| designCenterUrl | https://onetenth3.mycafe24.com/ |
| demoMallUrl | https://onetenth3.mycafe24.com/ |
| productCode | ONETENTH03 |
...
node scripts/preview-original.js onetenth3
# 재기동: node scripts/preview-original.js onetenth3 --force
```
