# 10pages-svc0006 — Source

| 항목 | 값 |
|------|-----|
| caseId | `10pages-svc0006` |
| displayName | 10PAGE SAMPLE MARKETING |
| designCenterUrl | https://a246476f9.10pages.co.kr/ |
| demoMallUrl | https://a246476f9.10pages.co.kr/ |
| productCode | SVC0006 |
...
node scripts/preview-original.js 10pages-svc0006
# 재기동: node scripts/preview-original.js 10pages-svc0006 --force
```
