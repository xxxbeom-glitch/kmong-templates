...
|------|-----|
| caseId | `ptmd871337` |
| displayName | PTMD871337 |
| designCenterUrl | https://d.cafe24.com/sample?productCode=PTMD871337&frame=P |
| demoMallUrl | https://ecudemo389695.cafe24.com/ |
| productCode | PTMD871337 |
...
node scripts/preview-original.js ptmd871337
# 재기동: node scripts/preview-original.js ptmd871337 --force
```
