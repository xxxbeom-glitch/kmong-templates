...
|------|-----|
| caseId | `onetenth6` |
| displayName | 십분의일 비즈니스 06 |
| designCenterUrl | https://onetenth6.mycafe24.com/ |
| demoMallUrl | https://onetenth6.mycafe24.com/ |
| productCode | ONETENTH06 |
...
node scripts/preview-original.js onetenth6
# 재기동: node scripts/preview-original.js onetenth6 --force
```
